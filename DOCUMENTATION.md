...
This simple command searches for the catalytic triad of serine proteases, extracted from the structure PDN:1gl0 provided in PDB format as file `1gl0.pdb`, in a set of PDB structures provided as list of 
...
`java -jar Fit3D.jar template-free -t 1gy2.A`
...
| template-based | -P    | --p-values             | Enables the calculation of p-values for matches accoring to FOFANOV et al. or STARK et al. Argument must either ‘F’ or ‘S’.                                                                                                                                                                                                                  | none                                      |
...
| template-free  | -m    | --mapping              | Use a mapping scheme to group residues. Must be either ‘C’ (chemical groups) or ‘F’ (functional groups) GUTTERIDGE.                                                                                                                                                                                                                          | none                                      |
